...
object Questions {
    fun getQuestions(): MutableList<Question>{
        ...
        questions.add(q10)
        val q11 = Question(11,
            image = R.drawable.qe11,"Q1. Calculate the Answer","Python","Java","C++","Kotlin",1)
        questions.add(q11)
        val q12 = Question(12,
            image = R.drawable.qe12,"Q2. Calculate the Answer","Python","Java","C++","Kotlin",1)
        questions.add(q12)
        val q13 = Question(13,
            image = R.drawable.qe13,"Q3. Calculate the Answer","Python","Java","C++","Kotlin",1)
        questions.add(q13)
        val q14 = Question(14,
            image = R.drawable.qe14,"Q4. Calculate the Answer","Python","Java","C++","Kotlin",1)
        questions.add(q14)
        val q15 = Question(15,
            image = R.drawable.qe15,"Q5. Calculate the Answer","Python","Java","C++","Kotlin",1)
        questions.add(q15)
        return questions
    }
}