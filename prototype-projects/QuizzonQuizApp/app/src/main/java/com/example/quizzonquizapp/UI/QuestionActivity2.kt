...
class QuestionActivity2 : AppCompatActivity(), View.OnClickListener {
    ...
    private fun setQuestion(){
        val q = questionlist[5+currentPosition-1]
            ...
            R.id.check -> {
                if(!answered){
                    ...
                    if(currentPosition <= 5 && !isLast) {
                        ...
                        Intent(this@QuestionActivity2, FinalActivity::class.java).also {
